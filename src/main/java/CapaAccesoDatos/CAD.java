...
public class CAD {
	 ...
	 * @return true si se creó exitosamente, false si el archivo ya existía o hubo
	 *         un error.
	 */
	 ...
	 * 
	 * @param r Objeto Respuesta que contiene el token a actualizar y el nuevo
	 *          contenido.
	 ...
	 * @return true si se borró correctamente, false si no se pudo eliminar o no
	 *         existía.
	 */
